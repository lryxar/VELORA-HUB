...
function createBot() {
  ...
  configs.watch(['config', 'tickets', 'permissions', 'welcome', 'suggestions', 'reviews', 'tax', 'say', 'logs', 'language']);
  ...
  client.once('ready', () => console.log(`VELORA HUB ready as ${client.user.tag}`));
